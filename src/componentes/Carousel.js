...
<CCarousel controls indicators>
  <CCarouselItem id="proceso">
    ...
    <CCarouselCaption className="d-none d-md-block">
      ...
      <p>El diseño  del prototipo de forma manual,  fue elaborado en clases para tener una referencia para la creación del modelo 3D. De esta forma resultó más sencillo plasmar las primeras ideas a través de dibujos hechos a mano..</p>
    </CCarouselCaption>
  </CCarouselItem>
  <CCarouselItem>
